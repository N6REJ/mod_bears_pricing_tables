...
.bears_pricing_tables' . $bears_moduleid . ' .plan.featured .plan-features li {
    color: var(--bears-featured-title-color);
}
...
.bears_pricing_tables' . $bears_moduleid . ' .plan-select a.btn {
    background-color: var(--bears-button-bg-color, var(--bears-button-text-color));
    color: #ffffff;
...
$document->addStyleSheet(Uri::base() . 'modules/mod_bears_pricing_tables/css/1214.css');
					...
					<div class="bears_pricing_tables">
						<div class="plan<?php echo $is_featured ? ' featured' : ''; ?> border-<?php echo $is_featured ? $bears_featured_border_style : $bears_border_style; ?>">
							...
							<div class="plan-select">
								<a href="<?php echo htmlspecialchars($bears_buttonurl[$cur_column] ?? '#'); ?>">
