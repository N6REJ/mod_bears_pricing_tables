...
class ModBearsPricingTablesHelper
{
    ...
    public static function getParams($params)
    {
        ...
        return array(
            ...
            'bears_price_subtitle_color' => $bears_price_subtitle_color,
    ...
    public static function generateCustomCSS($params)
    {
        ...
        if ($params->get('bears_price_subtitle_color')) {
            $css .= '--bears-price_subtitle-color: ' . $params->get('bears_price_subtitle_color') . ';';
        }
        ...
        if ($params->get('bears_button_color')) {
            $css .= '--bears-button-bg-color: ' . $params->get('bears_button_color') . ';';
        }
